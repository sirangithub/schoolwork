...
public class CategoryTableModel extends AbstractTableModel {
    ...
    public CategoryTableModel(ArrayList list) {
    ...
    public Object getValueAt(int arg0, int arg1) {
        ...
        return getPropertyValueByCol(cate, arg1);/////////////////////////////////////不完整
    }
    ...
    /**
     *setValueAt方法时使增加或修改值的时候生效，aValue就是你在单元格填的值，要把这些值保存到数据源中
     */
    ...
    public static void setChangeList(ArrayList changeList) {/////////////////////////////////////
